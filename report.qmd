...
pn.panel(
    pn.Column(
        ...
        pn.Tabulator(
            ...
            show_index=False,
            columns=[
                {"field": "F1", "frozen": True},
                {"field": "F2", "frozen": True},
                {"field": "F3", "frozen": True},
                {"field": "Total TOI (Min)"},
                {"field": "Shot Att%"},
                {"field": "GF%"},
                {"field": "Scoring Chance%"},
                {"field": "GF/60"},
                {"field": "GA/60"},
                {"field": "Shot Att For/60"},
                {"field": "Shot Att Against/60"}
            ],
        ...
        pn.Tabulator(
            ...
            columns=[
                ...
                {"field": "F2", "frozen": True},
                {"field": "F3", "frozen": True},
                {"field": "Time Spent up 3"},
                {"field": "Time Spent up 2"},
                {"field": "Time Spent up 1"},
                {"field": "Time spent tied"},
                {"field": "Time Spent down 1"},
                {"field": "Time Spent down 2"},
                {"field": "Time Spent down 3"},
                {"field": "Total TOI (Min)"},
                {"field": "DZ Starts"},
                {"field": "OZ Starts"}
            ],
        ...
        pn.Tabulator(
            ...
            show_index=False,
            columns=[
                {"field": "D1", "frozen": True},
                {"field": "D2", "frozen": True},
                {"field": "Total TOI (Min)"},
                {"field": "Shot Att%"},
                {"field": "GF%"},
                {"field": "Scoring Chance%"},
